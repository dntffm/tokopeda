...
<script src="<?=BASE_URL?>/admin-page/assets/js/jquery.dataTables.min.js"></script>
<script src="<?=BASE_URL?>/admin-page/assets/js/dataTables.bootstrap4.min.js"></script>
 <!-- Custom scripts for all pages-->
 <script src="<?=BASE_URL?>/admin-page/assets/js/sb-admin-2.min.js"></script>
 <script src="<?=BASE_URL?>/admin-page/assets/js/demo/datatables-demo.js"></script>
