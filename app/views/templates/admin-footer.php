 ...
 <!-- Page level plugins -->
 <script src="<?=BASE_URL?>/admin-page/assets/vendor/chart.js/Chart.min.js"></script>

 <!-- Page level custom scripts -->
 <script src="<?=BASE_URL?>/admin-page/assets/js/demo/chart-area-demo.js"></script>
 <script src="<?=BASE_URL?>/admin-page/assets/js/demo/chart-pie-demo.js"></script>
